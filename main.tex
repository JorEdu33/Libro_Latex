...
\begin{description}
  ...
  \item[Authors:] Jorge Eduardo Suárez Cortés and Daniel Alejandro Sánchez Rodríguez.
...
En primer lugar, para el diseño de un plan de aula modular, se realizó una revisión y selección de los contenidos teóricos y prácticos más relevantes de la asignatura, en conjunto con los docentes responsables (Anexo \ref{anexo:acta-abril-2025}). Con base en este documento, se elaboró el plan de aula modular correspondiente (Anexo \ref{anexo:Plan-de-aula-modular}), el cual fue implementado durante el desarrollo del proyecto. Este plan permitió definir con mayor claridad los contenidos, los recursos y herramientas tecnológicas, así como la metodología de enseñanza y aprendizaje. Posteriormente, estos contenidos fueron organizados en unidades interactivas implementadas en Colab Notebooks con Python y R, incorporando actividades prácticas y calificadores automáticos que ofrecieron retroalimentación inmediata.
...
Como resultado de los acuerdos definidos, se elaboró el plan de aula modular presentado en el Anexo \ref{anexo:Plan-de-aula-modular}, el cual consolida la estructura temática, las competencias y la metodología teórico-práctica basada en Colab Notebooks, R, Python y el uso de graders automáticos para la retroalimentación y evaluación de las actividades.
...
\begin{enumerate}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=0.7\textwidth]{Figs/Diagrama_contenedores.pdf}
...
\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.1cm} Desarrollo tecnológico del ambiente virtual. \textbf{Safe Exam Browser}.}
...
\begin{itemize}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=1\textwidth]{Figs/Detalles_practica.pdf}
		\label{fig:Detalles}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=0.95\textwidth]{Figs/Interfaz _de_notas.pdf}
		\label{fig:Interfaz}
...
\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.3cm} Infraestructura tecnológica implementada. \textbf{Dashboard de los túneles utilizados en Playit.gg}.}
...
\begin{figure}[ht]
	...
	\includegraphics[width=0.9\textwidth]{Figs/Diagrama_Flujo.pdf}
	\label{fig:DF}
...
\begin{figure}[ht]
	...
	\includegraphics[width=0.76\textwidth]{Figs/Presentacion_Genially.pdf}
	\label{fig:Pgenially}
...
\begin{figure}[ht]
	...
	\includegraphics[width=0.7\textwidth]{Figs/Infografia_Genially.pdf}
	\label{fig:Igenially}
...
\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.1cm} Recursos interactivos. \textbf{Infografía en H5P sobre Estadística descriptiva}.}
	\includegraphics[width=0.66\textwidth]{Figs/Infografia_H5P.pdf}
	\label{fig:H5P}
...
\begin{figure}[h]
	\centering
	\captionof{figure}{\\ \vspace{0.1cm} Experiencia de los Estudiantes. \textbf{Diagramas de: Ayuda de los practicantes y comprensión del contenido}.}
    \begin{subfigure}
        \centering
        \includegraphics[width=0.38\textwidth]{Figs/ayuda_practicantes.pdf}
    \end{subfigure}
	\hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.335\textwidth]{Figs/impacto_aprendizaje.pdf}
    \end{subfigure}
	\label{fig:Ayuda_Impacto}
	\\ Fuente: Elaboración propia a partir de la encuesta.
\end{figure}

Por otro lado, se resaltaron aspectos positivos relacionados con los métodos de enseñanza utilizados, los cuales fueron valorados como efectivos por el $56.7\%$ de los participantes. A esto se suma la percepción favorable hacia la calidad de los materiales teóricos, que obtuvo una aprobación del $66.7\%$ Figura \ref{fig:MM}. 

\begin{figure}[h]
	\centering
	\captionof{figure}{\\ \vspace{0.1cm} Experiencia de los Estudiantes. \textbf{Diagramas de los métodos y materiales usados en el curso}.}
    \begin{subfigure}
        \centering
        \includegraphics[width=0.37\textwidth]{Figs/Metodos_Enseñanza.pdf}
    \end{subfigure}
	\hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.37\textwidth]{Figs/materiales_teoricos.pdf}
    \end{subfigure}
	\label{fig:MM}
	\\ Fuente: Elaboración propia a partir de la encuesta.
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[width=0.36\textwidth]{Figs/Respuesta_Servidor.pdf}
    \end{subfigure}
	\hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.36\textwidth]{Figs/lenguaje_preferido.pdf}
    \end{subfigure}
	\label{fig:RL}
	\\ Fuente: Elaboración propia a partir de la encuesta.
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[width=0.35\textwidth]{Figs/uso_colab.pdf}
    \end{subfigure}
	\hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.47\textwidth]{Figs/uso_tecnologias.pdf}
    \end{subfigure}
	\label{fig:CT}
	\\ Fuente: Elaboración propia a partir de la encuesta.
\end{figure}
...
En la \textbf{Práctica 1} se presentó la mayor dificultad inicial: el  promedio es de $\bar{x}=3.36$, con una mediana de $3.50$, una desviación estándar de $\sigma=1.77$ y un rango intercuartílico $\text{IQR}$ de $3.00$. Estos indicadores reflejan un bajo desempeño general y una gran dispersión en los resultados, como se muestra en la Figura \ref{fig:Mapa}.

La \textbf{Práctica 2} marcó un avance notable en el rendimiento, con un promedio de $\bar{x}=4.46$, mediana de $5.00$, desviación estándar de $\sigma=1.51$ e $\text{IQR}$ de $0.0$. Este progreso se refleja también en la Figura \ref{fig:Dispersion}, donde se observa una concentración importante de calificaciones entre $4.0$ y $5.0$.

La \textbf{Práctica 3} representó el punto más alto del proceso formativo, alcanzando un promedio de $\bar{x}=4.50$, una mediana de $5.00$, desviación estándar de $\sigma=1.09$ e $\text{IQR}$ de $0.38$. Estos resultados muestran homogeneidad y predominio de notas altas, lo que sugiere que en este momento del curso los estudiantes lograron consolidar de manera más efectiva sus aprendizajes.

No obstante, en la \textbf{Práctica 4} ($\bar{x}=4.31$, mediana $5.00$, desviación estándar $\sigma=1.66$, $\text{IQR}$ $0.0$) y, sobre todo, en la \textbf{Práctica 5} ($\bar{x}=2.24$, mediana $2.80$, desviación estándar $\sigma=1.54$, $\text{IQR}$ $3.42$), se evidencia un retroceso importante. En esta última práctica, la Figura \ref{fig:Promedio} muestra una caída significativa de la mediana y una alta dispersión, mientras que la Figura \ref{fig:Dispersion} confirma la concentración de notas bajas, convirtiéndola en la actividad más crítica del proceso.

\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.1cm} Análisis de los grupos piloto. \textbf{Diagrama de dispersión de notas de las prácticas}.}
...
\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.1cm} Análisis de los grupos piloto. \textbf{Diagrama de boxplots de notas de las prácticas}.}
...
\begin{figure}[ht]
	\centering
	\captionof{figure}{ \\ \vspace{0.1cm} Análisis de los grupos piloto. \textbf{Mapa de Calor de notas de las prácticas}.}
	\includegraphics[width=0.85\textwidth]{Figs/Mapa_Notas.pdf}
	\label{fig:Mapa}
	\\Fuente: Elaboración propia a partir de las notas de las prácticas 1 a 5.
\end{figure}
...
En la Tabla \ref{tab:metricas} se presentan de manera sintética los principales resultados obtenidos durante el proceso de implementación y evaluación del AVA. La información integra tanto indicadores de desempeño académico en las prácticas y el cuestionario realizado, como métricas derivadas de la percepción estudiantil frente al uso de las herramientas tecnológicas. Esta síntesis de resultados proporciona una visión global y comparativa que permite analizar, de forma integral, los logros alcanzados y los aspectos susceptibles de mejora en el curso. Asimismo, la tabla constituye un insumo relevante para contrastar el impacto de la estrategia pedagógica desde una doble perspectiva: el rendimiento académico y la aceptación tecnológica por parte de los estudiantes.
...
\begin{table}[h!]
	...
	\begin{tabular}{|p{5cm}|p{5.5cm}|p{4.5cm}|} 
		...
		\hline
		Práctica 1 & Media / Mediana / $\sigma$ / IQR & 3.36 / 3.50 / 1.77 / 3.00 \\
		\hline
		Práctica 3 & Media / Mediana / $\sigma$ / IQR & 4.50 / 5.00 / 1.09 / 0.38 \\
		\hline
		Práctica 5 & Media / Mediana / $\sigma$ / IQR & 2.24 / 2.80 / 1.54 / 3.42 \\
		\hline
		Promedio global (P1-P5) & Media & 3.77 \\
		\hline
...
% --- Anexo 2 ---
\refstepcounter{chapter}
\chapter*{Anexo \thechapter: Plan modular}
\label{anexo:Plan modular}

\section*{Plan de aula modular}
\label{anexo:Plan-de-aula-modular}

\foreach \p in {1,...,3}{ % número de páginas del PDF
	\begin{figure}[H]
		\centering
		\includegraphics[page=\p, width=1.8\textwidth, height=0.765\textheight, keepaspectratio]{Anexos/Plan de aula.pdf}
	\end{figure}
}
