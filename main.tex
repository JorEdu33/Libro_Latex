...
\usepackage{minted} % Paquete para el resaltado de sintaxis
\usepackage{xcolor} % Paquete para los colores
\usepackage{caption} % Para los captions en el código
\usepackage{tcolorbox} % Opcional: para darle un fondo al código


% Definir colores personalizados para el código
\definecolor{bg}{rgb}{0.95,0.95,0.92} % Color de fondo del código
\definecolor{purple}{rgb}{0.5,0,0.5} % Color para palabras clave (como en Elixir)
\definecolor{orange}{rgb}{0.9,0.4,0} % Color para números
...
\lstdefinestyle{mystyle}{
    ...
    basicstyle=\ttfamily\footnotesize, % Cambié la fuente a pequeña (footnotesize)
    breakatwhitespace=false,
    breaklines=true,
    captionpos=b,
    keepspaces=true,
    numbers=none, % Ningún número de línea %left
    showspaces=false,
    showstringspaces=false,
    showtabs=false,
    tabsize=2,
    frame=single,            % Borde alrededor del listado
    rulecolor=\color{codeborder},  % Color del borde
    framesep=4pt,            % Espaciado entre el borde y el contenido
...
\begin{figure}[ht]
    \centering
    \captionof{figure}{ \\ \vspace{0.5cm} Costo en horas antes y después de la automatización}
    \includegraphics[width=0.38\textwidth]{Figs/costo_horas_automatizacion_barras_final (1).pdf}
